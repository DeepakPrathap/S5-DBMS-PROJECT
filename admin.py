...
def admin_panel():
    ...
    admin_panel_label = tk.Label(content_frame, text="Admin Panel", font="Montserrat, 45", bg="#E3F2FD")
    admin_panel_label.pack(pady=30)

    admin_panel_items_frame = tk.Label(content_frame, bg="#E3F2FD")
