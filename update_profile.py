...
def settings_icon():
        ...
        root2.focus_force()
        root2.grab_set()
        root2.config(bg='#E3F2FD')  # Modern light blue background

        title1=Label(root2,text="Edit User Profile",font=("Montserrat",17),bg="#E3F2FD")
        title1.place(relx=0.5,rely=.15,anchor=CENTER)

        email_label=Label(root2,text="E-mail",font=("Montserrat",12),bg='#E3F2FD')
        ...
        usernm_label=Label(root2,text="Username",font=("Montserrat",12),bg='#E3F2FD')
        ...
        biolbl=Label(root2,text="Biography",font=("Montserrat",12),bg='#E3F2FD')
