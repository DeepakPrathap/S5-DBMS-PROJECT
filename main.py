...
def register_page():
    ...
    frame2=Frame(root,bg='#E3F2FD')
    frame2.place(relx=.5,rely=.45,anchor=CENTER,width=430, height=520)

    label_title = Label(frame2, text="QUIZ APP", font=('Montserrat', 50),bg='#E3F2FD')
    label_title.place(relx=.5, rely=.1,anchor=CENTER)

    label_heading=Label(frame2,text='Create An Account',font=('Montserrat', 20),bg='#E3F2FD')
    label_heading.place(relx=.5,rely=.25,anchor=CENTER)

    label_mail = Label(frame2, text="E-mail",font=('Montserrat',15),bg='#E3F2FD')
    label_mail.place(relx=.05,rely=.4)
    new_mail = Entry(frame2,font=('Montserrat',11),bg='#FFFFFF')
    new_mail.place(relx=.5,rely=.4, width=180, height=30)

    label_name = Label(frame2, text="Username",font=('Montserrat',15),bg='#E3F2FD')
    label_name.place(relx=.05, rely=.48)
    new_name = Entry(frame2,font=('Montserrat',11),bg='#FFFFFF')
    new_name.place(relx=.5, rely=.48, width=180, height=30)

    label_pw = Label(frame2, text="New Password",font=('Montserrat',15),bg='#E3F2FD')
    label_pw.place(relx=.05, rely=.56)
    new_pw = Entry(frame2, show='*',font=('Montserrat',13),bg='#FFFFFF')
