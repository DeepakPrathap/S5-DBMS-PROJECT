...
def win(username, emai):
    ...
    root.config(bg='#E3F2FD')  # Modern light blue background
    ...
    ########## TO CALCULATE SCORE AND DISPLAY   #################
        ...
        def result():
            ...
            rslt=Label(root,text=f'Result of {cat} Quiz',font=('Montserrat',20,UNDERLINE,'bold'),bg='#E3F2FD')
            rslt.place(relx=0.5,rely=0.1,anchor=CENTER)
            usr=Label(root,text= f'Username: {username}',font=('Montserrat',16),bg='#E3F2FD')
            usr.place(relx=0.5,rely=0.17,anchor=CENTER)
            score_lbl=Label(root, text= f'Score: {score}', font=('Montserrat',16), bg='#E3F2FD')
            score_lbl.place(relx=0.5,rely=0.23,anchor=CENTER)
            dtl=Label(root,text='Detailed Report',font=('Montserrat',16,UNDERLINE),bg='#E3F2FD')
            dtl.place(relx=0.5,rely=0.3,anchor=CENTER)
            totqn=Label(root,text='Total Questions Attended:',font=('Montserrat',16),bg='#E3F2FD')
            totqn.place(relx=0.49,rely=0.37,anchor=CENTER)
            totqnlb=Label(root,text=qnn,bg='#FFFFFF',font=('Montserrat', 16))
            totqnlb.place(relx=0.6,rely=0.37, anchor=CENTER)
            crtans_lbl=Label(root,text='Correctly Answered:',font=('Montserrat',16),bg='#E3F2FD')
            crtans_lbl.place(relx=0.43,rely=0.4)
            crtanslb=Label(root,text=crt_ans,bg='#FFFFFF',font=('Montserrat', 16))
            crtanslb.place(relx=0.59,rely=0.4)
            wrngans_lbl=Label(root,text='Wrongly Answered:',font=('Montserrat',16),bg='#E3F2FD')
            wrngans_lbl.place(relx=0.43,rely=0.44)
            wrnganslb=Label(root,text=wrong_ans,bg='#FFFFFF',font=('Montserrat', 16))
            ...
            # Call feedback page after showing result
            root.after(500, lambda: FeedbackWindow(player_email=emai))
    ...
    ############## USER   ############
        ...
        def qn():
            ...
            if qnn<tot_qns: # change no of questions here
                ...
                s=Label(root,text=f'{qnn+1}. '+data[qnn][1],bg='#E3F2FD',font=('Montserrat', 18))
                s.place(relx=0.5,rely=0.2,anchor=CENTER)
                
                r1 = Radiobutton(root,text=data[qnn][2],variable=radiovar,value=data[qnn][2],bg='#E3F2FD',font=('Montserrat', 15))
                r1.place(relx=0.46,rely=0.3)
    
                r2 = Radiobutton(root,text=data[qnn][3],variable=radiovar,value=data[qnn][3],bg='#E3F2FD',font=('Montserrat', 15))
                r2.place(relx=0.46,rely=0.34)
    
                r3 = Radiobutton(root,text=data[qnn][4],variable=radiovar,value=data[qnn][4],bg='#E3F2FD',font=('Montserrat', 15))
                r3.place(relx=0.46,rely=0.38)
    
                r4 = Radiobutton(root,text=data[qnn][5],variable=radiovar,value=data[qnn][5],bg='#E3F2FD',font=('Montserrat', 15))
