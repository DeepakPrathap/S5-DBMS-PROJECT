...
bg_lbl=Label(root,image=bg1, bg='#E3F2FD').place(x=0, y=-0, relwidth=1, relheight=1)
...
def register_page():
    ...
    label_title = Label(root, text="QUIZ APP", font=('Montserrat', 50),bg='#E3F2FD')
    label_title.place(x=615, y=100)

    label_heading=Label(root,text='Create An Account',font=('Montserrat', 20),bg='#E3F2FD')
    label_heading.place(x=660,y=200)

    label_mail = Label(root, text="E-mail",font=('Montserrat',15),bg='#E3F2FD')
    label_mail.place(x=585, y=300)
    new_mail = Entry(root,font=('Montserrat',11),bg='#FFFFFF')
    new_mail.place(x=780, y=300, width=180, height=30)

    label_name = Label(root, text="Username",font=('Montserrat',15),bg='#E3F2FD')
    label_name.place(x=585, y=340)
    new_name = Entry(root,font=('Montserrat',11),bg='#FFFFFF')
    new_name.place(x=780, y=340, width=180, height=30)

    label_pw = Label(root, text="New Password",font=('Montserrat',15),bg='#E3F2FD')
    label_pw.place(x=585, y=380)
    new_pw = Entry(root, show='*',font=('Montserrat',13),bg='#FFFFFF')
    new_pw.place(x=780, y=380, width=180, height=30)
    pswd_show(root,new_pw,eye_img,960,383)

    label_confirm_pw = Label(root, text="Confirm Password",font=('Montserrat',15),bg='#E3F2FD')
    label_confirm_pw.place(x=585, y=420)
    new_cpw = Entry(root, show='*',font=('Montserrat',13),bg='#FFFFFF')
