...
def FrgtPwWin():
    ...
    frame=Frame(root2,bg='#E3F2FD')
    frame.place(x=35,y=20,width=280, height=360)

    title1=Label(root2,text="CHANGE PASSWORD",font=("Montserrat",17),bg="#E3F2FD")
    title1.place(x=50,y=40)

    email_label=Label(root2,text="Enter Email",font=("Montserrat",12),bg='#E3F2FD')
    email_label.place(x=65,y=100)
    email_entry=Entry(root2, bg='#FFFFFF',font=('Montserrat',11))
    email_entry.place(x=68,y=125,width=200,height=25)

    usernm_label=Label(root2,text="Enter Username",font=("Montserrat",12),bg='#E3F2FD')
    usernm_label.place(x=65,y=150)
    usernm_entry=Entry(root2, bg='#FFFFFF',font=('Montserrat',11))
    usernm_entry.place(x=68,y=175,width=200,height=25)

    newpw_label=Label(root2,text="New Password",font=("Montserrat",12),bg='#E3F2FD')
    newpw_label.place(x=65,y=200)
    newpw_entry=Entry(root2,show='*',bg='#FFFFFF',font=('Montserrat',11))
    newpw_entry.place(x=68,y=225,width=200,height=25)
    pswd_show(root2, newpw_entry, eye_imge, 270, 225)

    newcpw_label=Label(root2,text="Confirm Password",font=("Montserrat",12),bg='#E3F2FD')
    newcpw_label.place(x=65,y=250)
    newcpw_entry=Entry(root2,show='*',bg='#FFFFFF',font=('Montserrat',11))
    newcpw_entry.place(x=68,y=275,width=200,height=25)
    pswd_show(root2, newcpw_entry, eye_imge, 270, 275)

    next_btn=Button(root2,text="confirm",font=('Montserrat', 12),bg="#E3F2FD",command=check_entries)
